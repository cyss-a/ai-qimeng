...
1. 先搜索左侧的社区 Case 和[蓝皮书目录](/ai-qimeng/workbuddy/bluebook/)，确认场景或任务没有重复。
2. 阅读[Case 投稿指南](/ai-qimeng/workbuddy/community/case-contributing/)，复制标准模板。
...
<div class="case-intro-actions">
  <a class="case-intro-button case-intro-button--primary" href="/ai-qimeng/workbuddy/community/case-contributing/">提交你的 Case</a>
  <a class="case-intro-button" href="/ai-qimeng/workbuddy/bluebook/">阅读蓝皮书</a>
</div>
...
<section class="case-co-create" aria-labelledby="case-co-create-title">
  ...
  <a class="case-co-create__qr" href="/ai-qimeng/workbuddy-assets/cases/workbuddy-co-create-wechat.png" target="_blank" rel="noreferrer" aria-label="查看 WorkBuddy 共创联系人微信二维码大图">
    <img src="/ai-qimeng/workbuddy-assets/cases/workbuddy-co-create-wechat.png" alt="刘聪NLP 微信二维码，添加时备注 workbuddy共创" loading="lazy">
