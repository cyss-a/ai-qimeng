...
![在 WorkBuddy 中安装 Vibe Resume Skill](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/install-skill.png)

安装完成后，WorkBuddy 会提示 Skill 已经可以使用。

![Vibe Resume Skill 安装完成](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/skill-ready.png)

Skill 里有 12 套简历模板。可以让 WorkBuddy 把模板列出来，挑一套自己喜欢的；如果不想选，直接使用默认模板也可以。

![WorkBuddy 列出 12 套简历模板](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/template-list.png)
...
![把个人经历、照片和目标岗位发给 WorkBuddy](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/send-resume-materials.png)

WorkBuddy 读完材料后，开始整理内容和排版。第一版生成完成时，右侧可以直接预览整份简历，同时还会得到 HTML、PDF 和预览图。

![WorkBuddy 生成第一版简历](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/first-resume-result.png)
...
![增加经历并调整排版后的简历](/ai-qimeng/workbuddy-assets/cases/submissions/vibe-resume/assets/final-resume-result.png)
