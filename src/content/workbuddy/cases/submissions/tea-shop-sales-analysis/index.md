...
![案例封面：门店运营分析看板](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/cover.jpg)
...
![总部实际收到的门店 Excel：列名、格式、币种单位五花八门](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/mess-data.jpg)
...
![Excel 分析报告](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/report-xlsx.jpg)

**HTML 驾驶舱**：深绿品牌色 + 金点缀的咨询所风格，KPI 卡、5 张图表、门店明细表全部全局联动；趋势图支持拖拽选月。聚合数值经 node 脚本多场景模拟校验，与 Excel 报告完全一致。

![HTML 驾驶舱：全局联动的交互看板](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/cover.jpg)

**执行过程**：WorkBuddy 接到任务指令后开始执行（左图）；清洗完成后，它会先汇报发现了哪些脏数据问题、做了哪些处理假设，由人确认口径后再继续（右图）。

![在 WorkBuddy 中下达任务指令](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/workbuddy-task.jpg)

![WorkBuddy 汇报发现的脏数据问题与处理结果](/ai-qimeng/workbuddy-assets/cases/submissions/tea-shop-sales-analysis/assets/workbuddy-cleaning.jpg)
