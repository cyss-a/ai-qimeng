...
![workbuddy添加ima连接器](/ai-qimeng/workbuddy-assets/cases/submissions/wechat-ima-knowledge/assets/小程序一键存入ima.jpg)

### 第二步：在 WorkBuddy 中添加 ima 连接器

在 WorkBuddy 中打开连接器管理面板，搜索并添加「ima 知识库」连接器，完成授权。授权完成后，WorkBuddy 就能读取你的 ima 知识库内容了。

![workbuddy添加ima连接器](/ai-qimeng/workbuddy-assets/cases/submissions/wechat-ima-knowledge/assets/workbuddy添加ima连接器.png)
