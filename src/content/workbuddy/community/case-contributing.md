...
社区案例集用于收录大家已经在 WorkBuddy 中实际跑通过的任务。案例合并后会自动出现在[社区案例集](/ai-qimeng/workbuddy/cases/)；经过进一步复现和编辑的经典任务，未来可能进入蓝皮书正文。
...
请先搜索[社区案例集](/ai-qimeng/workbuddy/cases/)和[蓝皮书目录](/ai-qimeng/workbuddy/bluebook/)，自行确认场景或任务是否已经存在。相同目标、相同流程或仅更换输入数据的内容，建议直接补充现有案例；如果新 Case 使用了明显不同的 Skill、方法或交付方式，请在 PR 中说明差异。
